...
export default ({
  ...
  summary="Summary: By uncovering pain points of the organization's website, I was able to construct a brand and mobile website better suited for the West Sound Wildlife Shelter's target users.",
  takeaway="Main Takeaway: Visual design has the potential to solve problems, & has the power to promote small nonprofits in their large endeavors",
      ...
      <SingleColumn>
        <Project>
          <Content>
            ...
            <Link href={projurl}>📚 Next Project: K-12 Outreach Impact</Link>
          </Content>
          <Proto>
            <Callout>{callout}</Callout>
            <Iframe 
              url="https://www.figma.com/embed?embed_host=share&url=https%3A%2F%2Fwww.figma.com%2Fproto%2FuxbYrGptosm0L2iJlId0TD%2FPortfolio%3Fnode-id%3D196%253A42%26viewport%3D-399%252C87%252C0.24727918207645416%26scaling%3Dscale-down&chrome=DOCUMENTATION"
              width="300px"
              height="600px"
              id="myId"
              display="initial"
